...
write.zoo(SP500, file="CSV Files/SP500.csv", sep=",")
write.zoo(NAREIT, file="CSV Files/NAREIT.csv", sep=",")
write.zoo(EAFE, file="CSV Files/EAFE.csv", sep=",")
write.zoo(GSCI, file="CSV Files/GSCI.csv", sep=",")
```
