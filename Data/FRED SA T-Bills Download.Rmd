...
#Note no value for sep 1987
INTGSTZAM193N["1987-09-01"] <- 8.67
...
```{r}
#save as CSV files
write.zoo(Tbill.yield, file="CSV files/SA Long Term/TBILLYIELDS.csv", sep=",")
```
...
write.table(TBillIndex, "clipboard", sep="\t", col.names=TRUE)

Returns <- Return.calculate(TBillIndex["1972-12-31::2016-12-31"])[-1,]
...
```{r}
#save as CSV files
write.zoo(TBillIndex, file="CSV files/SA Long Term/TBILLS.csv", sep=",")
```
...
data(managers)
TbillMonthlyTReturns <- managers[,10]
Return.annualized(TbillMonthlyTReturns["1998//2002"])
SharpeRatio.annualized(TbillMonthlyTReturns["1998//2002"],TbillMonthlyTReturns["1998//2002"])
