...
Strategies <- c("B&H","Timing","Timing Delayed","Multi Timing","Multi Strat")
...
TimeInMarket <- c(nrow(AllAssets.xts[SubsetPeriod.Reporting]),
                  ...
                  sum(AllAssets.xts$SP500.avg.combo.signal[SubsetPeriod.Reporting]))/nrow(AllAssets.xts[SubsetPeriod.Reporting])
...
Returns <- cbind.xts(AllAssets.xts$EAFE.ret, 
                     ...
                     AllAssets.xts$EAFE.avg.combo)[SubsetPeriod.Reporting]
...
Returns <- cbind.xts(AllAssets.xts$US10YR.ret, 
                     ...
                     AllAssets.xts$US10YR.avg.combo)[SubsetPeriod.Reporting]
...
TimeInMarket <- c(nrow(AllAssets.xts[SubsetPeriod.Reporting]),
                  ...
                  sum(AllAssets.xts$US10YR.avg.combo.signal[SubsetPeriod.Reporting]))/nrow(AllAssets.xts[SubsetPeriod.Reporting])
...
Returns <- cbind.xts(AllAssets.xts$NAREIT.ret, 
                     ...
                     AllAssets.xts$NAREIT.avg.combo)[SubsetPeriod.Reporting]
...
TimeInMarket <- c(nrow(AllAssets.xts[SubsetPeriod.Reporting]),
                  ...
                  sum(AllAssets.xts$NAREIT.avg.combo.signal[SubsetPeriod.Reporting]))/nrow(AllAssets.xts[SubsetPeriod.Reporting])
...
Returns <- cbind.xts(AllAssets.xts$BuyandHold.ret,
                     ...
                     AllAssets.xts$Avg.Combo.ret)[SubsetPeriod.Faber]
...
TimeInMarket <- c(nrow(AllAssets.xts[SubsetPeriod.Reporting]),
                  ...
                  sum(AllAssets.xts$Avg.Combo.signal[SubsetPeriod.Reporting]))/nrow(AllAssets.xts[SubsetPeriod.Reporting])
