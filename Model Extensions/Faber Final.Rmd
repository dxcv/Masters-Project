...
charts.RollingPerformance(Returns[,1:2],
                          width = 12)
...
CorrelationData <- cbind.xts(AllAssets.xts$SP500.ret, 
                             AllAssets.xts$EAFE.ret,
                             AllAssets.xts$NAREIT.ret
                             #AllAssets.xts$GSCI.ret
                             #AllAssets.xts$US10YR.ret
                             )[SubsetPeriod.Reporting]

chart.RollingCorrelation(AllAssets.xts$GSCI.ret[SubsetPeriod.Reporting], 
                         CorrelationData[SubsetPeriod.Reporting], 
                         #AllAssets.xts$GSCI.ret[SubsetPeriod.Reporting], 
                         main = "GSCI Correlations",
                         width = 36, legend.loc = "bottomleft", 
                         colorset = c("olivedrab","slateblue","dodgerblue2")
                         )
