...
AllAssets <- AllAssets["2010-12-31::2016-12-31"]
...
SubsetPeriod <- "2010-12-31::2016-12-31"
...
CorrelationData <- CorrelationData["2010-11-30::2016-12-31"]
...
chart.RollingCorrelation(CorrelationData.ret, BITCOIN.ret, width = 12, legend.loc = "bottomleft")
