...
Returns <- cbind.xts(AllAssets.xts$MSCIWORLD.ret, 
                     ...
                     AllAssets.xts$MSCIWORLD.avg.combo)[SubsetPeriod.Reporting]
...
TimeInMarket <- c(nrow(AllAssets.xts[SubsetPeriod.Reporting]),
                  ...
                  sum(AllAssets.xts$MSCIWORLD.avg.combo.signal[SubsetPeriod.Reporting]))/nrow(AllAssets.xts[SubsetPeriod.Reporting])
...
Returns <- cbind.xts(AllAssets.xts$SA10YR.ret, 
                     ...
                     AllAssets.xts$SA10YR.avg.combo)[SubsetPeriod.Reporting]
...
TimeInMarket <- c(nrow(AllAssets.xts[SubsetPeriod.Reporting]),
                  ...
                  sum(AllAssets.xts$SA10YR.avg.combo.signal[SubsetPeriod.Reporting]))/nrow(AllAssets.xts[SubsetPeriod.Reporting])
...
TimeInMarket <- c(nrow(AllAssets.xts[SubsetPeriod.Reporting]),
                  ...
                  sum(AllAssets.xts$JASPY.avg.combo.signal[SubsetPeriod.Reporting]))/nrow(AllAssets.xts[SubsetPeriod.Reporting])
