...
AllAssets.df  <- mutate(AllAssets.df,
  ...
  "SAMAF.BuyandHold.ret" = (JALSH.ret * 0.25 
                           +MSCIWORLD.ret * 0.15 
                           +SA10YR.ret * 0.25 
                           +GSCI.ret * 0.1 
                           +JASPY.ret * 0.25),
  
  "SAMAF.Timing.ret" = (JALSH.10m.timingret * 0.25 
                       +MSCIWORLD.10m.timingret * 0.15 
                       +SA10YR.10m.timingret * 0.25 
                       +GSCI.10m.timingret * 0.1 
                       +JASPY.10m.timingret * 0.25 ),
  
  "SAMAF.Timing.signal" = (JALSH.10m.signal * 0.25 
                          +MSCIWORLD.10m.signal * 0.15 
                          +SA10YR.10m.signal * 0.25 
                          +GSCI.10m.signal * 0.1 
                          +JASPY.10m.signal * 0.25 ),
  
  "SAMAF.Avg.Combo.Band.ret" = (JALSH.avg.combo.band * 0.25 
                               +MSCIWORLD.avg.combo.band * 0.15 
                               +SA10YR.avg.combo.band * 0.25 
                               +GSCI.avg.combo.band * 0.1 
                               +JASPY.avg.combo.band * 0.25 ),
  
  "SAMAF.Avg.Combo.Band.signal" = (JALSH.avg.combo.band.signal * 0.25 
...
```{r}
Returns <- cbind.xts(AllAssets.xts$WMAF.BuyandHold.ret,
                     AllAssets.xts$WMAF.Timing.ret,
                     AllAssets.xts$WMAF.Avg.Combo.Band.ret,
                     AllAssets.xts$SAMAF.BuyandHold.ret,
                     AllAssets.xts$SAMAF.Timing.ret,
                     AllAssets.xts$SAMAF.Avg.Combo.Band.ret)[SubsetPeriod.Reporting]

colnames(Returns) <- c("WMAF B&H","WMAF Timing","WMAF Multi","SAMAF B&H","SAMAF Timing","SAMAF Multi")
