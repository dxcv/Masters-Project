...
require(quantstrat)
symbols <- c("SP500","EAFE","US10YR","GSCI","NAREIT","TBills")
...
colnames(AllAssets) <- symbols[1:5]
...
* confirm correct rate for Rf (Faber uses 5.41%) and that sharpe ratio is calculating correctly
...
To demostrate the logic and characteristics of the timing system, Faber tests the S&P back to 1901
