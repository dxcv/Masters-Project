...
chart.TimeSeries(AllAssets.cumret["1972-12-31::2012-12-31"],
                 main = "Figure 1 - Asset Class Returns 1973-2012, Log Scale",
                 #lty = "2",
                 ylab = "",
                 ylog = TRUE,
                 ylim = c(40,6000),
...
### Extending to 2016
```{r}
chart.TimeSeries(AllAssets.cumret["1972-12-31::2016-12-31"],
                 main = "Figure 2 - Asset Class Returns 1973-2016, Log Scale",
                 #lty = "2",
                 ylab = "",
                 ylog = TRUE,
                 ylim = c(40,6000),
...
```{r}
chart.TimeSeries(AllAssets.cumret["2012-12-31::2016-12-31"],
                 main = "Figure 3 - Asset Class Returns 2012-2016, Non-log Scale",
                 #lty = "2",
                 ylab = "",
                 ylog = FALSE,
                 ylim = c(500,8000),
...
stats <- rbind(Return.annualized(Returns,scale = 12), 
               StdDev.annualized(Returns,scale = 12), 
               SharpeRatio.annualized(Returns,Rf = AllAssets.ret$TBILLS),
               maxDrawdown(Returns,scale = 12,invert = FALSE),
               c(Return.annualized(Returns$CPI,scale = 12)))

colnames(stats) <- symbols
rownames(stats) <- c("Return","Volatility","Sharpe (5.41%)","MaxDD","Inflation CAGR")
stats <- round(stats[,-7],4)
stats
write.table(stats, "clipboard", sep="\t", col.names=NA) #copies to clipboad for word/excel
```
